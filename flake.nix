...
#    formatter = forEachSystem (pkgs: pkgs.alejandra);
    ...
    nixosConfigurations = {
      ...
      # Personal laptop
      hp-x360 = lib.nixosSystem {
        modules = [./hosts/hp-x360];
        specialArgs = {
          inherit inputs outputs;
        };
      };
    ...
    homeConfigurations = {
      ...
      # Main desktop
      "sd@tower" = lib.homeManagerConfiguration {
        modules = [./home/sd/tower.nix ./home/sd/nixpkgs.nix];
      ...
      # Personal laptop
      "sd@hp-x360" = lib.homeManagerConfiguration {
        modules = [./home/sd/hp-x360.nix ./home/sd/nixpkgs.nix];
        pkgs = pkgsFor.x86_64-linux;
        extraSpecialArgs = {
          inherit inputs outputs;
        };
